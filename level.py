...
class Level():
    ...
    def build_6(self):
        ...
        pig.life = 40
        self.pigs.append(pig)
        pig = Pig(820, 75, self.space)
        self.pigs.append(pig)
        pig = Pig(720, 75, self.space)
        self.pigs.append(pig)
    ...
    def build_10(self):
        ...
        self.horizontal_pile(820, 1, 4)
        self.horizontal_pile(1100, 1, 4)
        self.number_of_birds = 4
        if self.bool_space:
            self.number_of_birds = 8
